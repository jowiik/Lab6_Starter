...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		const articleElementRoot = document.createElement('article');
		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component
		const styleElementRoot = document.createElement('style');
		...
		* {
		...
		this.shadowRoot.appendChild(articleElementRoot);
		this.shadowRoot.appendChild(styleElementRoot);
	}
